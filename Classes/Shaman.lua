...
if (select(2, UnitClass('player')) == 'SHAMAN') then
	...
	Hekili.Default( "@Elemental, Cooldowns", "actionLists", 2.13, "^1^T^SEnabled^B^SSpecialization^N262^SRelease^N2.05^SScript^S^SActions^T^N1^T^SEnabled^b^SName^SBloodlust^SRelease^N2.06^SAbility^Sbloodlust^SScript^Starget.health.pct<25|time>0.500^t^N2^T^SEnabled^b^SName^SHeroism^SRelease^N2.06^SAbility^Sheroism^SScript^Starget.health.pct<25|time>0.500^t^N3^T^SEnabled^B^SName^SBerserking^SRelease^N2.06^SAbility^Sberserking^SScript^S!buff.bloodlust.up&!buff.elemental_mastery.up&(set_bonus.tier15_4pc_caster=1|(buff.ascendance.cooldown_remains=0&(dot.flame_shock.remains>buff.ascendance.duration|level<87)))^t^N4^T^SEnabled^B^SName^SBlood~`Fury^SRelease^N2.06^SAbility^Sblood_fury^SScript^Sbuff.bloodlust.up|buff.ascendance.up|((cooldown.ascendance.remains>10|level<87)&cooldown.fire_elemental_totem.remains>10)^t^N5^T^SEnabled^B^SName^SElemental~`Mastery^SRelease^N2.06^SAbility^Selemental_mastery^SScript^Saction.lava_burst.cast_time>=1.2^t^N6^T^SEnabled^B^SAbility^Sstorm_elemental_totem^SName^SStorm~`Elemental~`Totem^SRelease^N2.06^t^N7^T^SEnabled^B^SName^SFire~`Elemental~`Totem^SRelease^N2.06^SAbility^Sfire_elemental_totem^SScript^S!active^t^N8^T^SEnabled^B^SName^SAscendance^SRelease^N2.06^SAbility^Sascendance^SScript^Sactive_enemies>1|(dot.flame_shock.remains>buff.ascendance.duration&(target.time_to_die<20|buff.bloodlust.up|time>=60)&cooldown.lava_burst.remains>0)^t^t^SName^S@Elemental,~`Cooldowns^t^^" )
