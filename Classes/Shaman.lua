...
if (select(2, UnitClass("player")) == "SHAMAN") then
	...
	Hekili.Default( "@Elemental, Single Target", "actionLists", "^1^T^SName^S@Elemental,~`Single~`Target^SSpecialization^N262^SActions^T^N1^T^SEnabled^B^SScript^Stotem.fire.remains>=15^SName^SLiquid~`Magma^SAbility^Sliquid_magma^t^N2^T^SEnabled^B^SScript^S!buff.ascendance.up^SName^SAncestral~`Swiftness^SAbility^Sancestral_swiftness^t^N3^T^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&!buff.ascendance.up^SName^SUnleash~`Flame^SAbility^Sunleash_flame^t^N4^T^SEnabled^B^SName^SSpiritwalker's~`Grace^SArgs^S^SAbility^Sspiritwalkers_grace^SScript^Sbuff.ascendance.up&moving^t^N5^T^SEnabled^B^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^SName^SEarth~`Shock^SAbility^Searth_shock^t^N6^T^SEnabled^B^SScript^Sdot.flame_shock.remains>cast_time&(buff.ascendance.up|cooldown_react)^SName^SLava~`Burst^SAbility^Slava_burst^t^N7^T^SEnabled^B^SScript^Sdot.flame_shock.remains<=9^SName^SFlame~`Shock^SAbility^Sflame_shock^t^N8^T^SEnabled^B^SScript^S(set_bonus.tier17_4pc&buff.lightning_shield.react>=15&!buff.lava_surge.up)|(!set_bonus.tier17_4pc&buff.lightning_shield.react>15)^SName^SEarth~`Shock~`(1)^SAbility^Searth_shock^t^N9^T^SEnabled^B^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=(1.5+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&buff.elemental_mastery.down&buff.bloodlust.down^SName^SEarthquake^SAbility^Searthquake^t^N10^T^SEnabled^B^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=1.3*(1.5+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up|buff.bloodlust.up)^SName^SEarthquake~`(1)^SAbility^Searthquake^t^N11^T^SEnabled^B^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=(1.5+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.remains>=10|buff.bloodlust.remains>=10)^SName^SEarthquake~`(2)^SAbility^Searthquake^t^N12^T^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=((1.3*1.5)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&buff.elemental_mastery.down&buff.bloodlust.down^SName^SEarthquake~`(3)^SAbility^Searthquake^t^N13^T^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=1.3*((1.3*1.5)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up|buff.bloodlust.up)^SName^SEarthquake~`(4)^SAbility^Searthquake^t^N14^T^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=((1.3*1.5)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.remains>=10|buff.bloodlust.remains>=10)^SName^SEarthquake~`(5)^SAbility^Searthquake^t^N15^T^SEnabled^B^SName^SElemental~`Blast^SAbility^Selemental_blast^t^N16^T^SEnabled^B^SScript^Stime>60&remains<=buff.ascendance.duration&cooldown.ascendance.remains+buff.ascendance.duration<duration^SName^SFlame~`Shock~`(1)^SAbility^Sflame_shock^t^N17^T^SEnabled^B^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^SName^SSearing~`Totem^SAbility^Ssearing_totem^t^N18^T^SEnabled^B^SName^SSpiritwalker's~`Grace~`(1)^SArgs^S^SAbility^Sspiritwalkers_grace^SScript^Smoving&((talent.elemental_blast.enabled&cooldown.elemental_blast.remains=0)|(cooldown.lava_burst.remains=0&!buff.lava_surge.react))^t^N19^T^SEnabled^B^SName^SLightning~`Bolt^SAbility^Slightning_bolt^t^t^SScript^S^t^^" )
	
	Hekili.Default( "@Elemental, 2-4 Cleave", "actionLists", "^1^T^SEnabled^B^SName^S@Elemental,~`2-4~`Cleave^SAbility^Slightning_bolt^SScript^S^SActions^T^N1^T^SAbility^Sliquid_magma^SEnabled^B^SScript^Stotem.fire.remains>=15^SName^SLiquid~`Magma^t^N2^T^SAbility^Sancestral_swiftness^SEnabled^B^SScript^S!buff.ascendance.up^SName^SAncestral~`Swiftness^t^N3^T^SAbility^Searthquake^SEnabled^B^SScript^S!perk.improved_chain_lightning.enabled|buff.improved_chain_lightning.up^SName^SEarthquake~`(0)^t^N4^T^SAbility^Schain_lightning^SEnabled^B^SScript^Sactive_enemies>2&!buff.improved_chain_lightning.up&cooldown.earthquake.remains>=cast_time^SName^SChain~`Lightning^t^N5^T^SAbility^Sunleash_flame^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&!buff.ascendance.up^SName^SUnleash~`Flame^t^N6^T^SEnabled^B^SName^SSpiritwalker's~`Grace^SArgs^S^SAbility^Sspiritwalkers_grace^SScript^Sbuff.ascendance.up&moving^t^N7^T^SAbility^Searth_shock^SEnabled^B^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^SName^SEarth~`Shock^t^N8^T^SAbility^Slava_burst^SEnabled^B^SScript^Sdot.flame_shock.remains>cast_time&(buff.ascendance.up|cooldown_react)^SName^SLava~`Burst^t^N9^T^SAbility^Sflame_shock^SEnabled^B^SScript^Sdot.flame_shock.remains<=9^SName^SFlame~`Shock^t^N10^T^SAbility^Searth_shock^SEnabled^B^SScript^S(set_bonus.tier17_4pc&buff.lightning_shield.react>=15&!buff.lava_surge.up)|(!set_bonus.tier17_4pc&buff.lightning_shield.react>15)^SName^SEarth~`Shock~`(1)^t^N11^T^SAbility^Searthquake^SEnabled^B^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=(1.5+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&buff.elemental_mastery.down&buff.bloodlust.down^SName^SEarthquake^t^N12^T^SAbility^Searthquake^SEnabled^B^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=1.3*(1.5+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up|buff.bloodlust.up)^SName^SEarthquake~`(1)^t^N13^T^SAbility^Searthquake^SEnabled^B^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=(1.5+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.remains>=10|buff.bloodlust.remains>=10)^SName^SEarthquake~`(2)^t^N14^T^SAbility^Searthquake^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=((1.3*1.5)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&buff.elemental_mastery.down&buff.bloodlust.down^SName^SEarthquake~`(3)^t^N15^T^SAbility^Searthquake^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=1.3*((1.3*1.5)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up|buff.bloodlust.up)^SName^SEarthquake~`(4)^t^N16^T^SAbility^Searthquake^SEnabled^B^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=((1.3*1.5)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.remains>=10|buff.bloodlust.remains>=10)^SName^SEarthquake~`(5)^t^N17^T^SEnabled^B^SName^SElemental~`Blast^SAbility^Selemental_blast^t^N18^T^SAbility^Sflame_shock^SEnabled^B^SScript^Stime>60&remains<=buff.ascendance.duration&cooldown.ascendance.remains+buff.ascendance.duration<duration^SName^SFlame~`Shock~`(1)^t^N19^T^SAbility^Ssearing_totem^SEnabled^B^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^SName^SSearing~`Totem^t^N20^T^SEnabled^B^SName^SSpiritwalker's~`Grace~`(1)^SArgs^S^SAbility^Sspiritwalkers_grace^SScript^Smoving&((talent.elemental_blast.enabled&cooldown.elemental_blast.remains=0)|(cooldown.lava_burst.remains=0&!buff.lava_surge.react))^t^N21^T^SAbility^Schain_lightning^SEnabled^B^SScript^Sactive_enemies>1^SName^SChain~`Lightning~`(1)^t^N22^T^SEnabled^B^SScript^S^SName^SLightning~`Bolt^SAbility^Slightning_bolt^t^t^SSpecialization^N262^t^^" )
	
	Hekili.Default( "@Elemental, AOE", "actionLists", "^1^T^SActions^T^N1^T^SAbility^Sancestral_swiftness^SEnabled^B^SScript^S!buff.ascendance.up^SName^SAncestral~`Swiftness^t^N2^T^SAbility^Sliquid_magma^SEnabled^B^SScript^Spet.searing_totem.remains>=15|pet.fire_elemental_totem.remains>=15^SName^SLiquid~`Magma^t^N3^T^SAbility^Searthquake^SEnabled^B^SScript^S(!perk.enhanced_chain_lightning.enabled|buff.improved_chain_lightning.up)&active_enemies>=2^SName^SEarthquake^t^N4^T^SEnabled^B^SName^SLava~`Beam^SAbility^Slava_beam^t^N5^T^SAbility^Searth_shock^SEnabled^B^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^SName^SEarth~`Shock^t^N6^T^SAbility^Sthunderstorm^SEnabled^B^SScript^Sactive_enemies>=10^SName^SThunderstorm^t^N7^T^SAbility^Ssearing_totem^SEnabled^B^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^SName^SSearing~`Totem^t^N8^T^SAbility^Schain_lightning^SEnabled^B^SScript^Sactive_enemies>=2^SName^SChain~`Lightning^t^N9^T^SEnabled^B^SName^SLightning~`Bolt^SAbility^Slightning_bolt^t^t^SScript^S^SSpecialization^N262^SName^S@Elemental,~`AOE^t^^" )
	
	Hekili.Default( "@Elemental, Cooldowns", "actionLists", "^1^T^SEnabled^B^SSpecialization^N262^SAbility^Sbloodlust^SScript^S^SActions^T^N1^T^SAbility^Sbloodlust^SEnabled^b^SScript^Starget.health_pct<25|time>0.500^SName^SBloodlust^t^N2^T^SEnabled^b^SScript^Starget.health_pct<25|time>0.500^SName^SHeroism^SAbility^Sheroism^t^N3^T^SAbility^Sberserking^SEnabled^B^SScript^S!buff.bloodlust.up&!buff.elemental_mastery.up&(set_bonus.tier15_4pc_caster=1|(buff.ascendance.cooldown_remains=0&(dot.flame_shock.remains>buff.ascendance.duration|level<87)))^SName^SBerserking^t^N4^T^SAbility^Sblood_fury^SEnabled^B^SScript^Sbuff.bloodlust.up|buff.ascendance.up|((cooldown.ascendance.remains>10|level<87)&cooldown.fire_elemental_totem.remains>10)^SName^SBlood~`Fury^t^N5^T^SAbility^Selemental_mastery^SEnabled^B^SScript^Saction.lava_burst.cast_time>=1.2^SName^SElemental~`Mastery^t^N6^T^SEnabled^B^SName^SStorm~`Elemental~`Totem^SAbility^Sstorm_elemental_totem^t^N7^T^SAbility^Sfire_elemental_totem^SEnabled^B^SScript^S!active^SName^SFire~`Elemental~`Totem^t^N8^T^SAbility^Sascendance^SEnabled^B^SScript^Sactive_enemies>1|(dot.flame_shock.remains>buff.ascendance.duration&cooldown.lava_burst.remains>0)^SName^SAscendance^t^t^SName^S@Elemental,~`Cooldowns^t^^" )
