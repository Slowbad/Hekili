...
if (select(2, UnitClass("player")) == "SHAMAN") then
	...
	Hekili.Default( "@Enhancement, AOE", 'actionLists',  2.06,"^1^T^SEnabled^B^SSpecialization^N263^SRelease^N2.05^SActions^T^N1^T^SEnabled^B^SName^SLiquid~`Magma^SScript^Spet.searing_totem.remains>=15|pet.magma_totem.remains>=15|pet.fire_elemental_totem.remains>=15^SAbility^Sliquid_magma^t^N2^T^SEnabled^B^SName^SAncestral~`Swiftness^SAbility^Sancestral_swiftness^t^N3^T^SEnabled^B^SName^SUnleash~`Elements^SScript^Sactive_enemies>=4&dot.flame_shock.ticking&(cooldown.shock.remains>cooldown.fire_nova.remains|cooldown.fire_nova.remains=0)^SAbility^Sunleash_elements^t^N4^T^SEnabled^B^SName^SFire~`Nova^SScript^Sactive_dot.flame_shock>=3^SAbility^Sfire_nova^t^N5^T^SEnabled^B^SName^SWait^SArgs^Ssec=cooldown.fire_nova.remains^SAbility^Swait^SScript^Sactive_dot.flame_shock>=4&cooldown.fire_nova.remains<=action.fire_nova.gcd^t^N6^T^SEnabled^B^SName^SMagma~`Totem^SScript^S!totem.fire.active^SAbility^Smagma_totem^t^N7^T^SEnabled^B^SName^SLava~`Lash^SScript^Sdot.flame_shock.ticking&(active_dot.flame_shock<active_enemies|!talent.echo_of_the_elements.enabled|!buff.echo_of_the_elements.up)^SAbility^Slava_lash^t^N8^T^SEnabled^B^SName^SElemental~`Blast^SScript^S!buff.unleash_flame.up&(buff.maelstrom_weapon.react>=4|buff.ancestral_swiftness.up)^SAbility^Selemental_blast^t^N9^T^SEnabled^B^SName^SChain~`Lightning^SScript^Sglyph.chain_lightning.enabled&active_enemies>=4&(buff.maelstrom_weapon.react=5|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3))^SAbility^Schain_lightning^t^N10^T^SEnabled^B^SName^SUnleash~`Elements~`(1)^SScript^Sactive_enemies<4^SAbility^Sunleash_elements^t^N11^T^SEnabled^B^SName^SFlame~`Shock^SArgs^Scycle_targets=1^SAbility^Sflame_shock^SScript^S!ticking^t^N12^T^SEnabled^B^SName^SLightning~`Bolt^SScript^S(!glyph.chain_lightning.enabled|active_enemies<=3)&(buff.maelstrom_weapon.react=5|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3))^SAbility^Slightning_bolt^t^N13^T^SEnabled^B^SName^SWindstrike^SAbility^Swindstrike^t^N14^T^SEnabled^B^SName^SElemental~`Blast~`(1)^SScript^S!buff.unleash_flame.up&buff.maelstrom_weapon.react>=1^SAbility^Selemental_blast^t^N15^T^SEnabled^B^SName^SChain~`Lightning~`(1)^SScript^Sglyph.chain_lightning.enabled&active_enemies>=4&buff.maelstrom_weapon.react>=1^SAbility^Schain_lightning^t^N16^T^SEnabled^B^SName^SFire~`Nova~`(1)^SScript^Sactive_dot.flame_shock>=2^SAbility^Sfire_nova^t^N17^T^SEnabled^B^SName^SMagma~`Totem~`(1)^SScript^Stotem.fire.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^SAbility^Smagma_totem^t^N18^T^SEnabled^B^SName^SStormstrike^SAbility^Sstormstrike^t^N19^T^SEnabled^B^SName^SFrost~`Shock^SScript^Sactive_enemies<4^SAbility^Sfrost_shock^t^N20^T^SEnabled^B^SName^SElemental~`Blast~`(2)^SScript^Sbuff.maelstrom_weapon.react>=1^SAbility^Selemental_blast^t^N21^T^SEnabled^B^SName^SChain~`Lightning~`(2)^SScript^Sactive_enemies>=3&buff.maelstrom_weapon.react>=1^SAbility^Schain_lightning^t^N22^T^SEnabled^B^SName^SLightning~`Bolt~`(1)^SScript^Sactive_enemies<3&buff.maelstrom_weapon.react>=1^SAbility^Slightning_bolt^t^N23^T^SEnabled^B^SName^SFire~`Nova~`(2)^SScript^Sactive_dot.flame_shock>=1^SAbility^Sfire_nova^t^t^SName^S@Enhancement,~`AOE^t^^" )
