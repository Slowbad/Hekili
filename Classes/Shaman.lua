...
if (select(2, UnitClass('player')) == 'SHAMAN') then
  ...
  ns.initializeClassModule = function ()
    ...
    -- Import strings
    storeDefault( "Enh: Single Target", "actionLists", 20150226.2, "^1^T^SEnabled^B^SName^SEnh:~`Single~`Target^SRelease^N20150224.1^SDefault^B^SActions^T^N1^T^SEnabled^B^SName^SLiquid~`Magma^SRelease^F6923632657205036^f-35^SAbility^Sliquid_magma^SScript^Stoggle.magma&totem.fire.remains>10^t^N2^T^SEnabled^B^SAbility^Sancestral_swiftness^SName^SAncestral~`Swiftness^SRelease^F6923632657205036^f-35^t^N3^T^SEnabled^B^SName^SSearing~`Totem^SRelease^F6923632657205036^f-35^SAbility^Ssearing_totem^SScript^S!totem.fire.active^t^N4^T^SEnabled^B^SName^SUnleash~`Elements^SRelease^F6923632657205036^f-35^SAbility^Sunleash_elements^SScript^S(talent.unleashed_fury.enabled|set_bonus.tier16_2pc_melee)^t^N5^T^SEnabled^B^SName^SElemental~`Blast^SRelease^F6923632657205036^f-35^SAbility^Selemental_blast^SScript^Sbuff.maelstrom_weapon.react>=4|buff.ancestral_swiftness.up^t^N6^T^SEnabled^B^SName^SWindstrike^SRelease^F6923632657205036^f-35^SAbility^Swindstrike^SScript^S!talent.echo_of_the_elements.enabled|(talent.echo_of_the_elements.enabled&(charges=2|(action.windstrike.charges_fractional>1.75)|(charges=1&buff.ascendance.remains<1.5)))^t^N7^T^SEnabled^B^SName^SLightning~`Bolt^SRelease^F6923632657205036^f-35^SAbility^Slightning_bolt^SScript^Sbuff.maelstrom_weapon.react=5^t^N8^T^SEnabled^B^SName^SStormstrike^SRelease^F6923632657205036^f-35^SAbility^Sstormstrike^SScript^S!talent.echo_of_the_elements.enabled|(talent.echo_of_the_elements.enabled&(charges=2|(action.stormstrike.charges_fractional>1.75)|target.time_to_die<6))^t^N9^T^SEnabled^B^SName^SLava~`Lash^SRelease^F6923632657205036^f-35^SAbility^Slava_lash^SScript^S!talent.echo_of_the_elements.enabled|(talent.echo_of_the_elements.enabled&(charges=2|(action.lava_lash.charges_fractional>1.8)|target.time_to_die<8))^t^N10^T^SEnabled^B^SName^SFlame~`Shock^SRelease^F6923632657205036^f-35^SAbility^Sflame_shock^SScript^S(talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9)|!ticking^t^N11^T^SEnabled^B^SAbility^Sunleash_elements^SName^SUnleash~`Elements~`(1)^SRelease^F6923632657205036^f-35^t^N12^T^SEnabled^B^SName^SWindstrike~`(1)^SRelease^F6923632657205036^f-35^SAbility^Swindstrike^SScript^Stalent.echo_of_the_elements.enabled^t^N13^T^SEnabled^B^SName^SLightning~`Bolt~`(1)^SRelease^F6923632657205036^f-35^SAbility^Slightning_bolt^SScript^S(buff.maelstrom_weapon.react>=3&!buff.ascendance.up)|buff.ancestral_swiftness.up^t^N14^T^SEnabled^B^SName^SLava~`Lash~`(1)^SRelease^F6923632657205036^f-35^SAbility^Slava_lash^SScript^Stalent.echo_of_the_elements.enabled^t^N15^T^SEnabled^B^SName^SFrost~`Shock^SRelease^F6923632657205036^f-35^SAbility^Sfrost_shock^SScript^S(talent.elemental_fusion.enabled&dot.flame_shock.remains>=16)|!talent.elemental_fusion.enabled^t^N16^T^SEnabled^B^SName^SElemental~`Blast~`(1)^SRelease^F6923632657205036^f-35^SAbility^Selemental_blast^SScript^Sbuff.maelstrom_weapon.react>=1^t^N17^T^SEnabled^B^SName^SLightning~`Bolt~`(2)^SRelease^F6923632657205036^f-35^SAbility^Slightning_bolt^SScript^Stalent.echo_of_the_elements.enabled&((buff.maelstrom_weapon.react>=2&!buff.ascendance.up)|buff.ancestral_swiftness.up)^t^N18^T^SEnabled^B^SName^SStormstrike~`(1)^SRelease^F6923632657205036^f-35^SAbility^Sstormstrike^SScript^Stalent.echo_of_the_elements.enabled^t^N19^T^SEnabled^B^SName^SLightning~`Bolt~`(3)^SRelease^F6923632657205036^f-35^SAbility^Slightning_bolt^SScript^S(buff.maelstrom_weapon.react>=1&!buff.ascendance.up)|buff.ancestral_swiftness.up^t^N20^T^SEnabled^B^SName^SSearing~`Totem~`(1)^SRelease^F6923632657205036^f-35^SAbility^Ssearing_totem^SScript^Stotem.fire.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^t^t^SSpecialization^N263^t^^" )
