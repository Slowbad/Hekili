...
if (select(2, UnitClass('player')) == 'SHAMAN') then
	...
	Hekili.Default( "@Elemental, AOE", "actionLists", 2.06, "^1^T^SEnabled^B^SSpecialization^N262^SRelease^N2.05^SName^S@Elemental,~`AOE^SActions^T^N1^T^SEnabled^B^SScript^Stotem.fire.remains>=15^SRelease^N2.06^SName^SLiquid~`Magma^SAbility^Sliquid_magma^t^N2^T^SEnabled^B^SScript^S!buff.ascendance.up^SRelease^N2.06^SName^SAncestral~`Swiftness^SAbility^Sancestral_swiftness^t^N3^T^SEnabled^B^SName^SEarthquake^SArgs^Scycle_targets=1^SRelease^N2.06^SScript^S!ticking&(buff.enhanced_chain_lightning.up|level<=90)&active_enemies>=2^SAbility^Searthquake^t^N4^T^SAbility^Slava_beam^SRelease^N2.06^SName^SLava~`Beam^SEnabled^B^t^N5^T^SEnabled^B^SName^SEarth~`Shock^SRelease^N2.06^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^SAbility^Searth_shock^t^N6^T^SEnabled^B^SName^SThunderstorm^SRelease^N2.06^SScript^Sactive_enemies>=10^SAbility^Sthunderstorm^t^N7^T^SEnabled^B^SName^SSearing~`Totem^SRelease^N2.06^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^SAbility^Ssearing_totem^t^N8^T^SEnabled^B^SName^SChain~`Lightning^SRelease^N2.06^SScript^Sactive_enemies>=2^SAbility^Schain_lightning^t^N9^T^SAbility^Slightning_bolt^SRelease^N2.06^SName^SLightning~`Bolt^SEnabled^B^t^t^SScript^S^t^^" )
