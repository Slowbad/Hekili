...
if (select(2, UnitClass("player")) == "SHAMAN") then
	...
	Hekili.Default( "@Enhancement, 2 Cleave", "actionLists", 2.05,"^1^T^SEnabled^B^SName^S@Enhancement,~`2~`Cleave^SSpecialization^N263^SActions^T^N1^T^SAbility^Sliquid_magma^SEnabled^B^SName^SLiquid~`Magma^SScript^Stotem.fire.remains>=15^t^N2^T^SAbility^Smagma_totem^SEnabled^B^SName^SMagma~`Totem^SScript^S!totem.fire.active^t^N3^T^SAbility^Sancestral_swiftness^SEnabled^B^SName^SAncestral~`Swiftness^SScript^S^t^N4^T^SAbility^Sunleash_elements^SEnabled^B^SName^SUnleash~`Elements^SScript^S(talent.unleashed_fury.enabled|set_bonus.tier16_2pc_melee=1)^t^N5^T^SAbility^Selemental_blast^SEnabled^B^SName^SElemental~`Blast^SScript^Sbuff.maelstrom_weapon.react>=1^t^N6^T^SEnabled^B^SName^SChain~`Lightning^SAbility^Schain_lightning^SCaption^S!Glyph^SScript^S!glyph.chain_lightning.enabled&(buff.maelstrom_weapon.react=5|(buff.maelstrom_weapon.react>=4&!buff.ascendance.up)|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3))^t^N7^T^SAbility^Slightning_bolt^SEnabled^B^SName^SLightning~`Bolt^SScript^Sbuff.maelstrom_weapon.react=5|(buff.maelstrom_weapon.react>=4&!buff.ascendance.up)|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3)^t^N8^T^SEnabled^B^SName^SWindstrike^SAbility^Swindstrike^t^N9^T^SEnabled^B^SName^SStormstrike^SAbility^Sstormstrike^t^N10^T^SEnabled^B^SName^SLava~`Lash^SAbility^Slava_lash^t^N11^T^SAbility^Sflame_shock^SEnabled^B^SName^SFlame~`Shock^SScript^S(talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9)|!ticking^t^N12^T^SEnabled^B^SName^SUnleash~`Elements~`(1)^SAbility^Sunleash_elements^t^N13^T^SEnabled^B^SAbility^Sfire_nova^SName^SFire~`Nova^SScript^Sactive_dot.flame_shock>=2&!((talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9))^t^N14^T^SAbility^Sfrost_shock^SEnabled^B^SName^SFrost~`Shock^SScript^S(talent.elemental_fusion.enabled&dot.flame_shock.remains>=16)|!talent.elemental_fusion.enabled^t^N15^T^SEnabled^B^SName^SChain~`Lightning~`(1)^SAbility^Schain_lightning^SCaption^S!Glyph^SScript^S!glyph.chain_lightning.enabled&(buff.maelstrom_weapon.react>=1&!buff.ascendance.up)^t^N16^T^SAbility^Slightning_bolt^SEnabled^B^SName^SLightning~`Bolt~`(1)^SScript^Sbuff.maelstrom_weapon.react>=1&!buff.ascendance.up^t^N17^T^SAbility^Ssearing_totem^SEnabled^B^SName^SSearing~`Totem~`(1)^SScript^Stotem.fire.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^t^t^t^^" )
	
	Hekili.Default( "@Enhancement, 3 Cleave", "actionLists",  2.05,"^1^T^SEnabled^B^SSpecialization^N263^SActions^T^N1^T^SEnabled^B^SAbility^Sliquid_magma^SScript^Stotem.fire.remains>=15^SName^SLiquid~`Magma^t^N2^T^SEnabled^B^SAbility^Smagma_totem^SScript^S!totem.fire.active^SName^SMagma~`Totem^t^N3^T^SEnabled^B^SAbility^Sancestral_swiftness^SScript^S^SName^SAncestral~`Swiftness^t^N4^T^SEnabled^B^SAbility^Sunleash_elements^SScript^S(talent.unleashed_fury.enabled|set_bonus.tier16_2pc_melee=1)^SName^SUnleash~`Elements^t^N5^T^SEnabled^B^SAbility^Selemental_blast^SScript^Sbuff.maelstrom_weapon.react>=1^SName^SElemental~`Blast^t^N6^T^SEnabled^B^SName^SChain~`Lightning^SAbility^Schain_lightning^SCaption^S^SScript^Sbuff.maelstrom_weapon.react=5|(buff.maelstrom_weapon.react>=4&!buff.ascendance.up)|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3)^t^N7^T^SEnabled^B^SName^SWindstrike^SAbility^Swindstrike^t^N8^T^SEnabled^B^SAbility^Sfire_nova^SName^SFire~`Nova^SScript^Sactive_dot.flame_shock>=3&!((talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9))^t^N9^T^SEnabled^B^SName^SStormstrike^SAbility^Sstormstrike^t^N10^T^SEnabled^B^SName^SLava~`Lash^SAbility^Slava_lash^t^N11^T^SEnabled^B^SAbility^Sflame_shock^SScript^S(talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9)|!ticking^SName^SFlame~`Shock^t^N12^T^SEnabled^B^SName^SUnleash~`Elements~`(1)^SAbility^Sunleash_elements^t^N13^T^SEnabled^B^SAbility^Sfrost_shock^SScript^S(talent.elemental_fusion.enabled&dot.flame_shock.remains>=16)|!talent.elemental_fusion.enabled^SName^SFrost~`Shock^t^N14^T^SEnabled^B^SName^SChain~`Lightning~`(1)^SAbility^Schain_lightning^SCaption^S^SScript^Sbuff.maelstrom_weapon.react>=1&!buff.ascendance.up^t^N15^T^SEnabled^B^SAbility^Ssearing_totem^SScript^Stotem.fire.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^SName^SSearing~`Totem~`(1)^t^t^SName^S@Enhancement,~`3~`Cleave^t^^" )
	
	Hekili.Default( "@Enhancement, 4 Cleave", "actionLists",  2.05,"^1^T^SEnabled^B^SActions^T^N1^T^SAbility^Sliquid_magma^SEnabled^B^SName^SLiquid~`Magma^SScript^Stotem.fire.remains>=15^t^N2^T^SAbility^Smagma_totem^SEnabled^B^SName^SMagma~`Totem^SScript^S!totem.fire.active^t^N3^T^SAbility^Sancestral_swiftness^SEnabled^B^SName^SAncestral~`Swiftness^SScript^S^t^N4^T^SEnabled^B^SAbility^Sfire_nova^SName^SFire~`Nova^SScript^Sactive_dot.flame_shock>=4&!((talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9))^t^N5^T^SAbility^Sunleash_elements^SEnabled^B^SName^SUnleash~`Elements^SScript^S(talent.unleashed_fury.enabled|set_bonus.tier16_2pc_melee=1)^t^N6^T^SAbility^Selemental_blast^SEnabled^B^SName^SElemental~`Blast^SScript^Sbuff.maelstrom_weapon.react>=1^t^N7^T^SEnabled^B^SName^SChain~`Lightning^SAbility^Schain_lightning^SCaption^S^SScript^Sbuff.maelstrom_weapon.react=5|(buff.maelstrom_weapon.react>=4&!buff.ascendance.up)|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3)^t^N8^T^SEnabled^B^SName^SWindstrike^SAbility^Swindstrike^t^N9^T^SEnabled^B^SName^SStormstrike^SAbility^Sstormstrike^t^N10^T^SEnabled^B^SName^SLava~`Lash^SAbility^Slava_lash^t^N11^T^SAbility^Sflame_shock^SEnabled^B^SName^SFlame~`Shock^SScript^S(talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<16)|(!talent.elemental_fusion.enabled&buff.unleash_flame.up&dot.flame_shock.remains<=9)|!ticking^t^N12^T^SEnabled^B^SName^SUnleash~`Elements~`(1)^SAbility^Sunleash_elements^t^N13^T^SAbility^Sfrost_shock^SEnabled^B^SName^SFrost~`Shock^SScript^S(talent.elemental_fusion.enabled&dot.flame_shock.remains>=16)|!talent.elemental_fusion.enabled^t^N14^T^SEnabled^B^SName^SChain~`Lightning~`(1)^SAbility^Schain_lightning^SCaption^S^SScript^Sbuff.maelstrom_weapon.react>=1&!buff.ascendance.up^t^N15^T^SAbility^Ssearing_totem^SEnabled^B^SName^SSearing~`Totem~`(1)^SScript^Stotem.fire.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^t^t^SName^S@Enhancement,~`4~`Cleave^SSpecialization^N263^t^^" )
	
	Hekili.Default( "@Enhancement, AOE", 'actionLists',  2.05,"^1^T^SEnabled^B^SName^S@Enhancement,~`AOE^SSpecialization^N263^SActions^T^N1^T^SEnabled^B^SAbility^Sliquid_magma^SName^SLiquid~`Magma^SScript^Spet.searing_totem.remains>=15|pet.magma_totem.remains>=15|pet.fire_elemental_totem.remains>=15^t^N2^T^SEnabled^B^SName^SAncestral~`Swiftness^SAbility^Sancestral_swiftness^t^N3^T^SEnabled^B^SAbility^Sunleash_elements^SName^SUnleash~`Elements^SScript^Sactive_enemies>=4&dot.flame_shock.ticking&(cooldown.shock.remains>cooldown.fire_nova.remains|cooldown.fire_nova.remains=0)^t^N4^T^SEnabled^B^SAbility^Sfire_nova^SName^SFire~`Nova^SScript^Sactive_dot.flame_shock>=3^t^N5^T^SEnabled^B^SName^SWait^SArgs^Ssec=cooldown.fire_nova.remains^SAbility^Swait^SScript^Sactive_dot.flame_shock>=4&cooldown.fire_nova.remains<=action.fire_nova.gcd^t^N6^T^SEnabled^B^SAbility^Smagma_totem^SName^SMagma~`Totem^SScript^S!totem.fire.active^t^N7^T^SEnabled^B^SAbility^Slava_lash^SName^SLava~`Lash^SScript^Sdot.flame_shock.ticking&(active_dot.flame_shock<active_enemies|!talent.echo_of_the_elements.enabled|!buff.echo_of_the_elements.up)^t^N8^T^SEnabled^B^SAbility^Selemental_blast^SName^SElemental~`Blast^SScript^S!buff.unleash_flame.up&(buff.maelstrom_weapon.react>=4|buff.ancestral_swiftness.up)^t^N9^T^SEnabled^B^SAbility^Schain_lightning^SName^SChain~`Lightning^SScript^Sglyph.chain_lightning.enabled&active_enemies>=4&(buff.maelstrom_weapon.react=5|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3))^t^N10^T^SEnabled^B^SAbility^Sunleash_elements^SName^SUnleash~`Elements~`(1)^SScript^Sactive_enemies<4^t^N11^T^SEnabled^B^SName^SFlame~`Shock^SArgs^Scycle_targets=1^SAbility^Sflame_shock^SScript^S!ticking^t^N12^T^SEnabled^B^SAbility^Slightning_bolt^SName^SLightning~`Bolt^SScript^S(!glyph.chain_lightning.enabled|active_enemies<=3)&(buff.maelstrom_weapon.react=5|(buff.ancestral_swiftness.up&buff.maelstrom_weapon.react>=3))^t^N13^T^SEnabled^B^SName^SWindstrike^SAbility^Swindstrike^t^N14^T^SEnabled^B^SAbility^Selemental_blast^SName^SElemental~`Blast~`(1)^SScript^S!buff.unleash_flame.up&buff.maelstrom_weapon.react>=1^t^N15^T^SEnabled^B^SAbility^Schain_lightning^SName^SChain~`Lightning~`(1)^SScript^Sglyph.chain_lightning.enabled&active_enemies>=4&buff.maelstrom_weapon.react>=1^t^N16^T^SEnabled^B^SAbility^Sfire_nova^SName^SFire~`Nova~`(1)^SScript^Sactive_dot.flame_shock>=2^t^N17^T^SEnabled^B^SAbility^Smagma_totem^SName^SMagma~`Totem~`(1)^SScript^Spet.magma_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^t^N18^T^SEnabled^B^SName^SStormstrike^SAbility^Sstormstrike^t^N19^T^SEnabled^B^SAbility^Sfrost_shock^SName^SFrost~`Shock^SScript^Sactive_enemies<4^t^N20^T^SEnabled^B^SAbility^Selemental_blast^SName^SElemental~`Blast~`(2)^SScript^Sbuff.maelstrom_weapon.react>=1^t^N21^T^SEnabled^B^SAbility^Schain_lightning^SName^SChain~`Lightning~`(2)^SScript^Sactive_enemies>=3&buff.maelstrom_weapon.react>=1^t^N22^T^SEnabled^B^SAbility^Slightning_bolt^SName^SLightning~`Bolt~`(1)^SScript^Sactive_enemies<3&buff.maelstrom_weapon.react>=1^t^N23^T^SEnabled^B^SAbility^Sfire_nova^SName^SFire~`Nova~`(2)^SScript^Sactive_dot.flame_shock>=1^t^t^t^^" )
	
	Hekili.Default( "@Enhancement, Cooldowns", 'actionLists',  2.05,"^1^T^SEnabled^B^SName^S@Enhancement,~`Cooldowns^SSpecialization^N263^SActions^T^N1^T^SAbility^Sbloodlust^SName^SBloodlust^SScript^Starget.health_pct<25|time>0.500^SEnabled^b^t^N2^T^SEnabled^b^SAbility^Sheroism^SName^SHeroism^SScript^Starget.health_pct<25|time>0.500^t^N3^T^SEnabled^B^SName^SBlood~`Fury^SAbility^Sblood_fury^t^N4^T^SEnabled^B^SName^SBerserking^SAbility^Sberserking^t^N5^T^SEnabled^B^SName^SElemental~`Mastery^SAbility^Selemental_mastery^t^N6^T^SEnabled^B^SName^SStorm~`Elemental~`Totem^SAbility^Sstorm_elemental_totem^t^N7^T^SEnabled^B^SName^SFire~`Elemental~`Totem^SAbility^Sfire_elemental_totem^t^N8^T^SAbility^Sascendance^SName^SAscendance^SScript^S^SEnabled^B^t^N9^T^SEnabled^B^SName^SFeral~`Spirit^SAbility^Sferal_spirit^t^t^t^^" )
	
	Hekili.Default( "@Shaman, Interrupt", 'actionLists', 2.05, "^^1^T^SEnabled^B^SScript^S^SSpecialization^N0^SActions^T^N1^T^SEnabled^B^SName^SWind~`Shear^SAbility^Swind_shear^SCaption^SShear^SScript^Starget.casting^t^t^SName^S@Shaman,~`Interrupt^t^^" )
