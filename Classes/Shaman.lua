...
if (select(2, UnitClass('player')) == 'SHAMAN') then
  ...
  ns.initializeClassModule = function ()
    ...
    storeDefault( "Enh: AOE", 'actionLists',  20150107.2,"^1^T^SEnabled^B^SSpecialization^N263^SRelease^N20150107.1^SName^SEnh:~`AOE^SActions^T^N1^T^SEnabled^B^SRelease^N2.25^SName^SAncestral~`Swiftness^SAbility^Sancestral_swiftness^t^N2^T^SEnabled^B^SName^SLiquid~`Magma^SRelease^N2.25^SAbility^Sliquid_magma^SScript^Stoggle.magma&totem.fire.remains>=15^t^N3^T^SEnabled^B^SName^SUnleash~`Elements^SRelease^N2.25^SAbility^Sunleash_elements^SScript^Sactive_enemies>=4&dot.flame_shock.ticking&(cooldown.shock.remains>cooldown.fire_nova.remains|cooldown.fire_nova.remains=0)^t^N4^T^SEnabled^B^SName^SFire~`Nova^SRelease^N2.25^SAbility^Sfire_nova^SScript^Sactive_dot.flame_shock>=3^t^N5^T^SEnabled^B^SName^SWait^SArgs^Ssec=cooldown.fire_nova.remains^SRelease^N2.25^SAbility^Swait^SScript^Sactive_dot.flame_shock>=4&cooldown.fire_nova.remains<=action.fire_nova.gcd^t^N6^T^SEnabled^B^SName^SMagma~`Totem^SRelease^N2.25^SAbility^Smagma_totem^SScript^S!totem.fire.active^t^N7^T^SEnabled^B^SName^SLava~`Lash^SRelease^N2.25^SAbility^Slava_lash^SScript^Sdot.flame_shock.ticking&(active_dot.flame_shock<active_enemies|!talent.echo_of_the_elements.enabled|!buff.echo_of_the_elements.up)^t^N8^T^SEnabled^B^SName^SElemental~`Blast^SRelease^N2.25^SAbility^Selemental_blast^SScript^S!buff.unleash_flame.up&(buff.maelstrom_weapon.react>=4|buff.ancestral_swiftness.up)^t^N9^T^SEnabled^B^SName^SChain~`Lightning^SRelease^N2.25^SAbility^Schain_lightning^SScript^Sactive_enemies>=3&buff.maelstrom_weapon.react=5^t^N10^T^SEnabled^B^SName^SUnleash~`Elements~`(1)^SRelease^N2.25^SAbility^Sunleash_elements^SScript^Sactive_enemies<4^t^N11^T^SEnabled^B^SName^SFlame~`Shock^SArgs^Scycle_targets=1^SRelease^N2.25^SAbility^Sflame_shock^SScript^S!ticking^t^N12^T^SEnabled^B^SName^SLightning~`Bolt^SRelease^N2.25^SAbility^Slightning_bolt^SScript^Sactive_enemies=2&(!glyph.chain_lightning.enabled|buff.unleashed_fury.up)&buff.maelstrom_weapon.react=5^t^N13^T^SEnabled^B^SRelease^N2.25^SName^SWindstrike^SAbility^Swindstrike^t^N14^T^SEnabled^B^SName^SElemental~`Blast~`(1)^SRelease^N2.25^SAbility^Selemental_blast^SScript^S!buff.unleash_flame.up&buff.maelstrom_weapon.react>=1^t^N15^T^SScript^S(glyph.chain_lightning.enabled&active_enemies>=4)&(buff.maelstrom_weapon.react>=1|buff.ancestral_swiftness.up)^SAbility^Schain_lightning^SEnable/d^B^SRelease^N2.25^SName^SChain~`Lightning~`(1)^t^N16^T^SEnabled^B^SName^SFire~`Nova~`(1)^SRelease^N2.25^SAbility^Sfire_nova^SScript^Sactive_dot.flame_shock>=2^t^N17^T^SEnabled^B^SName^SMagma~`Totem~`(1)^SRelease^N2.25^SAbility^Smagma_totem^SScript^Stotem.fire.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up^t^N18^T^SEnabled^B^SRelease^N2.25^SName^SStormstrike^SAbility^Sstormstrike^t^N19^T^SEnabled^B^SName^SFrost~`Shock^SRelease^N2.25^SAbility^Sfrost_shock^SScript^Sactive_enemies<4^t^N20^T^SEnabled^B^SName^SElemental~`Blast~`(2)^SRelease^N2.25^SAbility^Selemental_blast^SScript^Sbuff.maelstrom_weapon.react>=1^t^N21^T^SEnabled^B^SName^SChain~`Lightning~`(2)^SRelease^N2.25^SAbility^Schain_lightning^SScript^Sactive_enemies>=3&(buff.maelstrom_weapon.react>=1|buff.ancestral_swiftness.up)^t^N22^T^SEnabled^B^SName^SLightning~`Bolt~`(1)^SRelease^N2.25^SAbility^Slightning_bolt^SScript^Sactive_enemies<3&(buff.maelstrom_weapon.react>=1|buff.ancestral_swiftness.up)^t^N23^T^SEnabled^B^SName^SFire~`Nova~`(2)^SRelease^N2.25^SAbility^Sfire_nova^SScript^Sactive_dot.flame_shock>=1^t^t^SDefault^B^t^^" )
