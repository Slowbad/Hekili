...
if (select(2, UnitClass('player')) == 'SHAMAN') then
	...
	Hekili.Default( "@Elemental, Single Target", "actionLists", 2.15, "^1^T^SEnabled^B^SSpecialization^N262^SRelease^N2.05^SScript^S^SActions^T^N1^T^SEnabled^B^SName^SAncestral~`Swiftness^SRelease^N2.06^SAbility^Sancestral_swiftness^SScript^S!buff.ascendance.up^t^N2^T^SEnabled^B^SName^SLiquid~`Magma^SRelease^N2.06^SAbility^Sliquid_magma^SScript^Spet.searing_totem.up>=15|pet.fire_elemental_totem.remains>=15^t^N3^T^SEnabled^B^SName^SUnleash~`Flame^SAbility^Sunleash_flame^SRelease^N2.06^SScript^Smoving^t^N4^T^SEnabled^B^SName^SSpiritwalker's~`Grace^SArgs^Smoving=1^SRelease^N2.06^SAbility^Sspiritwalkers_grace^SScript^Smoving&buff.ascendance.up^t^N5^T^SEnabled^B^SName^SEarth~`Shock^SRelease^N2.06^SAbility^Searth_shock^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^t^N6^T^SEnabled^B^SName^SLava~`Burst^SRelease^N2.06^SAbility^Slava_burst^SScript^Sdot.flame_shock.remains>cast_time&(buff.ascendance.up|cooldown_react)^t^N7^T^SEnabled^B^SName^SUnleash~`Flame~`(1)^SRelease^N2.06^SAbility^Sunleash_flame^SScript^Stalent.unleashed_fury.enabled&!buff.ascendance.up^t^N8^T^SEnabled^B^SName^SFlame~`Shock^SRelease^N2.06^SAbility^Sflame_shock^SScript^Sdot.flame_shock.up<=9^t^N9^T^SEnabled^B^SName^SEarth~`Shock~`(1)^SRelease^N2.06^SAbility^Searth_shock^SScript^S(set_bonus.tier17_4pc&buff.lightning_shield.react>=15&!buff.lava_surge.up)|(!set_bonus.tier17_4pc&buff.lightning_shield.react>15)^t^N10^T^SEnabled^B^SName^SEarthquake^SRelease^N2.06^SAbility^Searthquake^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=(1.875+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&buff.elemental_mastery.down&buff.bloodlust.down^t^N11^T^SEnabled^B^SName^SEarthquake~`(1)^SRelease^N2.06^SAbility^Searthquake^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=1.3*(1.875+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up|buff.bloodlust.up)^t^N12^T^SEnabled^B^SName^SEarthquake~`(2)^SRelease^N2.06^SAbility^Searthquake^SScript^S!talent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=(1.875+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up>=10|buff.bloodlust.remains>=10)^t^N13^T^SEnabled^B^SName^SEarthquake~`(3)^SRelease^N2.06^SAbility^Searthquake^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=((1.3*1.875)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&buff.elemental_mastery.down&buff.bloodlust.down^t^N14^T^SEnabled^B^SName^SEarthquake~`(4)^SRelease^N2.06^SAbility^Searthquake^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=1.3*((1.3*1.875)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.up|buff.bloodlust.up)^t^N15^T^SEnabled^B^SName^SEarthquake~`(5)^SRelease^N2.06^SAbility^Searthquake^SScript^Stalent.unleashed_fury.enabled&((1+stat.spell_haste)*(1+(mastery_value*2%4.5))>=((1.3*1.875)+(1.25*0.226305)+1.25*(2*0.226305*stat.multistrike_pct%100)))&target.time_to_die>10&(buff.elemental_mastery.remains>=10|buff.bloodlust.remains>=10)^t^N16^T^SEnabled^B^SAbility^Selemental_blast^SName^SElemental~`Blast^SRelease^N2.06^t^N17^T^SEnabled^B^SName^SFlame~`Shock~`(1)^SRelease^N2.06^SAbility^Sflame_shock^SScript^Stime>60&remains<=buff.ascendance.duration&cooldown.ascendance.remains+buff.ascendance.duration<duration^t^N18^T^SEnabled^B^SName^SSearing~`Totem^SRelease^N2.06^SAbility^Ssearing_totem^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^t^N19^T^SEnabled^B^SName^SSpiritwalker's~`Grace~`(1)^SArgs^Smoving=1^SRelease^N2.06^SAbility^Sspiritwalkers_grace^SScript^Smoving&((talent.elemental_blast.enabled&cooldown.elemental_blast.up=0)|(cooldown.lava_burst.remains=0&!buff.lava_surge.up))^t^N20^T^SEnabled^B^SAbility^Slightning_bolt^SName^SLightning~`Bolt^SRelease^N2.06^t^t^SName^S@Elemental,~`Single~`Target^t^^" )
	
	Hekili.Default( "@Elemental, 2-4 Cleave", "actionLists", 2.15, "^1^T^SEnabled^B^SSpecialization^N262^SRelease^N2.05^SScript^S^SActions^T^N1^T^SEnabled^B^SName^SAncestral~`Swiftness^SRelease^N2.06^SAbility^Sancestral_swiftness^SScript^S!buff.ascendance.up^t^N2^T^SEnabled^B^SName^SLiquid~`Magma^SRelease^N2.06^SAbility^Sliquid_magma^SScript^Spet.searing_totem.up>=15|pet.fire_elemental_totem.remains>=15^t^N3^T^SEnabled^B^SName^SUnleash~`Flame^SAbility^Sunleash_flame^SRelease^N2.06^SScript^Smoving^t^N4^T^SEnabled^B^SName^SSpiritwalker's~`Grace^SArgs^Smoving=1^SRelease^N2.06^SAbility^Sspiritwalkers_grace^SScript^Smoving&buff.ascendance.up^t^N5^T^SEnabled^B^SName^SEarthquake^SRelease^N2.06^SAbility^Searthquake^SScript^S(buff.enhanced_chain_lightning.up|!perk.improved_chain_lightning.enabled)&active_enemies>=2^t^N6^T^SEnabled^B^SScript^S^SRelease^N2.06^SAbility^Slava_beam^SName^SLava~`Beam^t^N7^T^SEnabled^B^SName^SChain~`Lightning^SRelease^N2.06^SAbility^Schain_lightning^SScript^Sperk.improved_chain_lightning.enabled&!buff.enhanced_chain_lightning.up^t^N8^T^SEnabled^B^SName^SEarth~`Shock^SRelease^N2.06^SAbility^Searth_shock^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^t^N9^T^SEnabled^B^SName^SLava~`Burst^SRelease^N2.06^SAbility^Slava_burst^SScript^Sdot.flame_shock.remains>cast_time&(buff.ascendance.up|cooldown_react)^t^N10^T^SEnabled^B^SName^SUnleash~`Flame~`(1)^SRelease^N2.06^SAbility^Sunleash_flame^SScript^Stalent.unleashed_fury.enabled&!buff.ascendance.up^t^N11^T^SEnabled^B^SName^SFlame~`Shock^SRelease^N2.06^SAbility^Sflame_shock^SScript^Sdot.flame_shock.up<=9^t^N12^T^SEnabled^B^SName^SEarth~`Shock~`(1)^SRelease^N2.06^SAbility^Searth_shock^SScript^S(set_bonus.tier17_4pc&buff.lightning_shield.react>=15&!buff.lava_surge.up)|(!set_bonus.tier17_4pc&buff.lightning_shield.react>15)^t^N13^T^SRelease^N2.06^SEnabled^B^SName^SElemental~`Blast^SAbility^Selemental_blast^t^N14^T^SEnabled^B^SName^SFlame~`Shock~`(1)^SRelease^N2.06^SAbility^Sflame_shock^SScript^Stime>60&remains<=buff.ascendance.duration&cooldown.ascendance.remains+buff.ascendance.duration<duration^t^N15^T^SEnabled^B^SName^SSearing~`Totem^SRelease^N2.06^SAbility^Ssearing_totem^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^t^N16^T^SEnabled^B^SName^SSpiritwalker's~`Grace~`(1)^SArgs^Smoving=1^SRelease^N2.06^SAbility^Sspiritwalkers_grace^SScript^Smoving&((talent.elemental_blast.enabled&cooldown.elemental_blast.up=0)|(cooldown.lava_burst.remains=0&!buff.lava_surge.up))^t^N17^T^SRelease^N2.06^SEnabled^B^SName^SLightning~`Bolt^SAbility^Slightning_bolt^t^t^SName^S@Elemental,~`2-4~`Cleave^t^^" )
	
	Hekili.Default( "@Elemental, AOE", "actionLists", 2.15, "^1^T^SEnabled^B^SSpecialization^N262^SRelease^N2.05^SName^S@Elemental,~`AOE^SActions^T^N1^T^SEnabled^B^SName^SAncestral~`Swiftness^SRelease^N2.06^SAbility^Sancestral_swiftness^SScript^S!buff.ascendance.up^t^N2^T^SEnabled^B^SName^SLiquid~`Magma^SRelease^N2.06^SAbility^Sliquid_magma^SScript^Spet.searing_totem.up>=15|pet.fire_elemental_totem.remains>=15^t^N3^T^SEnabled^B^SName^SEarthquake^SArgs^Scycle_targets=1^SRelease^N2.06^SAbility^Searthquake^SScript^S!ticking&(buff.enhanced_chain_lightning.up|level<=90)&active_enemies>=2^t^N4^T^SEnabled^B^SAbility^Slava_beam^SName^SLava~`Beam^SRelease^N2.06^t^N5^T^SEnabled^B^SName^SEarth~`Shock^SRelease^N2.06^SAbility^Searth_shock^SScript^Sbuff.lightning_shield.react=buff.lightning_shield.max_stack^t^N6^T^SEnabled^B^SName^SThunderstorm^SRelease^N2.06^SAbility^Sthunderstorm^SScript^Sactive_enemies>=10^t^N7^T^SEnabled^B^SName^SSearing~`Totem^SRelease^N2.06^SAbility^Ssearing_totem^SScript^S(!talent.liquid_magma.enabled&!totem.fire.active)|(talent.liquid_magma.enabled&pet.searing_totem.remains<=20&!pet.fire_elemental_totem.active&!buff.liquid_magma.up)^t^N8^T^SEnabled^B^SName^SChain~`Lightning^SRelease^N2.06^SAbility^Schain_lightning^SScript^Sactive_enemies>=2^t^N9^T^SEnabled^B^SAbility^Slightning_bolt^SName^SLightning~`Bolt^SRelease^N2.06^t^t^SScript^S^t^^" )
	
	Hekili.Default( "@Elemental, Cooldowns", "actionLists", 2.15, "^1^T^SEnabled^B^SSpecialization^N262^SScript^S^SAbility^Sbloodlust^SName^S@Elemental,~`Cooldowns^SActions^T^N1^T^SEnabled^b^SName^SBloodlust^SScript^Starget.health.pct<25|time>0.500^SAbility^Sbloodlust^t^N2^T^SEnabled^b^SName^SHeroism^SScript^Starget.health.pct<25|time>0.500^SAbility^Sheroism^t^N3^T^SEnabled^B^SName^SBerserking^SScript^S!buff.bloodlust.up&!buff.elemental_mastery.up&(set_bonus.tier15_4pc_caster=1|(buff.ascendance.cooldown_remains=0&(dot.flame_shock.remains>buff.ascendance.duration|level<87)))^SAbility^Sberserking^t^N4^T^SEnabled^B^SName^SBlood~`Fury^SScript^Sbuff.bloodlust.up|buff.ascendance.up|((cooldown.ascendance.remains>10|level<87)&cooldown.fire_elemental_totem.remains>10)^SAbility^Sblood_fury^t^N5^T^SEnabled^B^SName^SElemental~`Mastery^SScript^Saction.lava_burst.cast_time>=1.2^SAbility^Selemental_mastery^t^N6^T^SEnabled^B^SName^SStorm~`Elemental~`Totem^SAbility^Sstorm_elemental_totem^t^N7^T^SEnabled^B^SName^SFire~`Elemental~`Totem^SScript^S!active^SAbility^Sfire_elemental_totem^t^N8^T^SEnabled^B^SName^SAscendance^SScript^Sactive_enemies>1|(dot.flame_shock.remains>buff.ascendance.duration&(target.time_to_die<20|buff.bloodlust.up|time>=60)&cooldown.lava_burst.remains>0)^SAbility^Sascendance^t^t^SRelease^N2.05^t^^" )
