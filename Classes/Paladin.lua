...
if (select(2, UnitClass('player')) == 'PALADIN') then
  ...
  ns.initializeClassModule = function ()
    ...
    storeDefault( 'Prot: Mitigation', 'actionLists', 20150223.1, "^1^T^SEnabled^B^SScript^S^SDefault^B^SRelease^N20150116.1^SSpecialization^N66^SActions^T^N1^T^SEnabled^B^SName^SDivine~`Protection^SRelease^F6923632657205036^f-35^SAbility^Sdivine_protection^SScript^Stime<5|!talent.seraphim.enabled|(buff.seraphim.down&cooldown.seraphim.remains>5&cooldown.seraphim.remains<9)^t^N2^T^SEnabled^B^SName^SGuardian~`of~`Ancient~`Kings^SRelease^F6923632657205036^f-35^SAbility^Sguardian_of_ancient_kings^SScript^Stime<5|(buff.holy_avenger.down&buff.shield_of_the_righteous.down&buff.divine_protection.down)^t^N3^T^SEnabled^B^SName^SArdent~`Defender^SRelease^F6923632657205036^f-35^SAbility^Sardent_defender^SScript^Stime<5|(buff.holy_avenger.down&buff.shield_of_the_righteous.down&buff.divine_protection.down&buff.guardian_of_ancient_kings.down)^t^N4^T^SEnabled^B^SName^SEternal~`Flame^SRelease^F6923632657205036^f-35^SAbility^Seternal_flame^SScript^Sbuff.eternal_flame.remains<2&buff.bastion_of_glory.react>2&(holy_power.current>=3|buff.divine_purpose.up|buff.bastion_of_power.up)^t^N5^T^SEnabled^B^SName^SEternal~`Flame~`(1)^SRelease^F6923632657205036^f-35^SAbility^Seternal_flame^SScript^Sbuff.bastion_of_power.up&buff.bastion_of_glory.react>=5^t^t^SName^SProt:~`Mitigation^t^^" )
