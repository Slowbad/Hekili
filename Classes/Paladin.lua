...
if (select(2, UnitClass('player')) == 'PALADIN') then
  ...
  ns.initializeClassModule = function ()
    ...
    storeDefault( 'Ret: Single Target', 'actionLists', 20150107.1, "^1^T^SEnabled^B^SSpecialization^N70^SDefault^B^SRelease^N2.2^SScript^S^SActions^T^N1^T^SEnabled^B^SName^SJudgment^SRelease^N2.25^SAbility^Sjudgment^SScript^Stalent.empowered_seals.enabled&time<2^t^N2^T^SEnabled^B^SAbility^Sexecution_sentence^SName^SExecution~`Sentence^SRelease^N2.25^t^N3^T^SEnabled^B^SAbility^Slights_hammer^SName^SLight's~`Hammer^SRelease^N2.25^t^N4^T^SEnabled^B^SAbility^Sseraphim^SName^SSeraphim^SRelease^N2.25^t^N5^T^SEnabled^B^SName^SWait^SArgs^Ssec=cooldown.seraphim.remains^SRelease^N2.25^SAbility^Swait^SScript^Stalent.seraphim.enabled&cooldown.seraphim.remains>0&cooldown.seraphim.remains<gcd&holy_power.current>=5^t^N6^T^SEnabled^B^SName^SDivine~`Storm^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&buff.final_verdict.up^t^N7^T^SEnabled^B^SName^SDivine~`Storm~`(1)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&active_enemies=2&!talent.final_verdict.enabled^t^N8^T^SEnabled^B^SName^SDivine~`Storm~`(2)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^S(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&active_enemies=2&buff.final_verdict.up^t^N9^T^SEnabled^B^SName^SDivine~`Storm~`(3)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&(talent.seraphim.enabled&cooldown.seraphim.remains<gcd*4)^t^N10^T^SEnabled^B^SName^STemplar's~`Verdict^SRelease^N2.25^SAbility^Stemplars_verdict^SScript^S(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*4)^t^N11^T^SEnabled^B^SName^STemplar's~`Verdict~`(1)^SRelease^N2.25^SAbility^Stemplars_verdict^SScript^Sbuff.divine_purpose.up&buff.divine_purpose.remains<3^t^N12^T^SEnabled^B^SName^SDivine~`Storm~`(4)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&buff.divine_crusader.remains<3&!talent.final_verdict.enabled^t^N13^T^SEnabled^B^SName^SFinal~`Verdict^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^S(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)^t^N14^T^SEnabled^B^SName^SFinal~`Verdict~`(1)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sbuff.divine_purpose.up&buff.divine_purpose.remains<3^t^N15^T^SEnabled^B^SAbility^Shammer_of_wrath^SName^SHammer~`of~`Wrath^SRelease^N2.25^t^N16^T^SEnabled^B^SName^SJudgment~`(1)^SRelease^N2.25^SAbility^Sjudgment^SScript^Stalent.empowered_seals.enabled&seal.truth&buff.maraads_truth.remains<cooldown.judgment.duration^t^N17^T^SEnabled^B^SName^SJudgment~`(2)^SRelease^N2.25^SAbility^Sjudgment^SScript^Stalent.empowered_seals.enabled&seal.righteousness&buff.liadrins_righteousness.remains<cooldown.judgment.duration^t^N18^T^SEnabled^B^SName^SExorcism^SRelease^N2.25^SAbility^Sexorcism^SScript^Sbuff.blazing_contempt.up&holy_power.current<=2&buff.holy_avenger.down^t^N19^T^SEnabled^B^SName^SSeal~`of~`Truth^SRelease^N2.25^SAbility^Sseal_of_truth^SScript^Stalent.empowered_seals.enabled&buff.maraads_truth.down^t^N20^T^SEnabled^B^SName^SSeal~`of~`Righteousness^SRelease^N2.25^SAbility^Sseal_of_righteousness^SScript^Stalent.empowered_seals.enabled&buff.liadrins_righteousness.down&!buff.avenging_wrath.up&!buff.bloodlust.up^t^N21^T^SEnabled^B^SName^SDivine~`Storm~`(5)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&buff.final_verdict.up&(buff.avenging_wrath.up|target.health.pct<35)^t^N22^T^SEnabled^B^SName^SDivine~`Storm~`(6)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sactive_enemies=2&buff.final_verdict.up&(buff.avenging_wrath.up|target.health.pct<35)^t^N23^T^SEnabled^B^SName^SFinal~`Verdict~`(2)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sbuff.avenging_wrath.up|target.health.pct<35^t^N24^T^SEnabled^B^SName^STemplar's~`Verdict~`(2)^SRelease^N2.25^SAbility^Stemplars_verdict^SScript^Sbuff.avenging_wrath.up|target.health.pct<35&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*5)^t^N25^T^SEnabled^B^SName^SCrusader~`Strike^SRelease^N2.25^SAbility^Scrusader_strike^SScript^Sholy_power.current<5^t^N26^T^SEnabled^B^SName^SDivine~`Storm~`(7)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(buff.avenging_wrath.up|target.health.pct<35)&!talent.final_verdict.enabled^t^N27^T^SEnabled^B^SName^SJudgment~`(3)^SArgs^Scycle_targets=1^SRelease^N2.25^SAbility^Sjudgment^SScript^Slast_judgment_target!=target.unit&glyph.double_jeopardy.enabled&holy_power.current<5^t^N28^T^SEnabled^B^SName^SExorcism~`(1)^SRelease^N2.25^SAbility^Sexorcism^SScript^Sglyph.mass_exorcism.enabled&active_enemies>=2&holy_power.current<5&!glyph.double_jeopardy.enabled^t^N29^T^SEnabled^B^SName^SJudgment~`(4)^SRelease^N2.25^SAbility^Sjudgment^SScript^Sholy_power.current<5^t^N30^T^SEnabled^B^SName^SDivine~`Storm~`(8)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&buff.final_verdict.up^t^N31^T^SEnabled^B^SName^SDivine~`Storm~`(9)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sactive_enemies=2&holy_power.current>=4&buff.final_verdict.up^t^N32^T^SEnabled^B^SName^SFinal~`Verdict~`(3)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sbuff.divine_purpose.up^t^N33^T^SEnabled^B^SName^SFinal~`Verdict~`(4)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sholy_power.current>=4^t^N34^T^SEnabled^B^SName^SDivine~`Storm~`(10)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&active_enemies=2&holy_power.current>=4&!talent.final_verdict.enabled^t^N35^T^SEnabled^B^SName^STemplar's~`Verdict~`(3)^SRelease^N2.25^SAbility^Stemplars_verdict^SScript^Sbuff.divine_purpose.up^t^N36^T^SEnabled^B^SName^SDivine~`Storm~`(11)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&!talent.final_verdict.enabled^t^N37^T^SEnabled^B^SName^STemplar's~`Verdict~`(4)^SRelease^N2.25^SAbility^Stemplars_verdict^SScript^Sholy_power.current>=4&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*5)^t^N38^T^SEnabled^B^SName^SSeal~`of~`Truth~`(1)^SRelease^N2.25^SAbility^Sseal_of_truth^SScript^Stalent.empowered_seals.enabled&buff.maraads_truth.remains<cooldown.judgment.duration^t^N39^T^SEnabled^B^SName^SSeal~`of~`Righteousness~`(1)^SRelease^N2.25^SAbility^Sseal_of_righteousness^SScript^Stalent.empowered_seals.enabled&buff.liadrins_righteousness.remains<cooldown.judgment.duration&!buff.bloodlust.up^t^N40^T^SEnabled^B^SName^SExorcism~`(2)^SRelease^N2.25^SAbility^Sexorcism^SScript^Sholy_power.current<5^t^N41^T^SEnabled^B^SName^SDivine~`Storm~`(12)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sactive_enemies=2&holy_power.current>=3&buff.final_verdict.up^t^N42^T^SEnabled^B^SName^SFinal~`Verdict~`(5)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sholy_power.current>=3^t^N43^T^SEnabled^B^SName^STemplar's~`Verdict~`(5)^SRelease^N2.25^SAbility^Stemplars_verdict^SScript^Sholy_power.current>=3&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*6)^t^N44^T^SEnabled^B^SAbility^Sholy_prism^SName^SHoly~`Prism^SRelease^N2.25^t^t^SName^SRet:~`Single~`Target^t^^" )
    
    storeDefault( 'Ret: AOE', 'actionLists', 20150107.2, "^1^T^SEnabled^B^SScript^S^SSpecialization^N70^SRelease^N2.21^SName^SRet:~`AOE^SActions^T^N1^T^SEnabled^B^SName^SJudgment^SRelease^N2.25^SAbility^Sjudgment^SScript^Stalent.empowered_seals.enabled&time<2^t^N2^T^SEnabled^B^SAbility^Sexecution_sentence^SName^SExecution~`Sentence^SRelease^N2.25^t^N3^T^SEnabled^B^SAbility^Slights_hammer^SName^SLight's~`Hammer^SRelease^N2.25^t^N4^T^SEnabled^B^SAbility^Sseraphim^SName^SSeraphim^SRelease^N2.25^t^N5^T^SEnabled^B^SName^SWait^SArgs^Ssec=cooldown.seraphim.remains^SRelease^N2.25^SAbility^Swait^SScript^Stalent.seraphim.enabled&cooldown.seraphim.remains>0&cooldown.seraphim.remains<gcd&holy_power.current>=5^t^N6^T^SEnabled^B^SName^SFinal~`Verdict^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sbuff.final_verdict.down&(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)^t^N7^T^SEnabled^B^SName^SDivine~`Storm^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&buff.final_verdict.up^t^N8^T^SEnabled^B^SName^SDivine~`Storm~`(1)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^S(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&buff.final_verdict.up^t^N9^T^SEnabled^B^SName^SDivine~`Storm~`(2)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&!talent.final_verdict.enabled^t^N10^T^SEnabled^B^SName^SDivine~`Storm~`(3)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^S(holy_power.current=5|buff.holy_avenger.up&holy_power.current>=3)&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*4)&!talent.final_verdict.enabled^t^N11^T^SEnabled^B^SAbility^Shammer_of_wrath^SName^SHammer~`of~`Wrath^SRelease^N2.25^t^N12^T^SEnabled^B^SName^SExorcism^SRelease^N2.25^SAbility^Sexorcism^SScript^Sbuff.blazing_contempt.up&holy_power.current<=2&buff.holy_avenger.down^t^N13^T^SEnabled^B^SName^SJudgment~`(1)^SRelease^N2.25^SAbility^Sjudgment^SScript^Stalent.empowered_seals.enabled&seal.righteousness&buff.liadrins_righteousness.remains<=5^t^N14^T^SEnabled^B^SName^SDivine~`Storm~`(4)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&buff.final_verdict.up&(buff.avenging_wrath.up|target.health.pct<35)^t^N15^T^SEnabled^B^SName^SDivine~`Storm~`(5)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.final_verdict.up&(buff.avenging_wrath.up|target.health.pct<35)^t^N16^T^SEnabled^B^SName^SFinal~`Verdict~`(1)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sbuff.final_verdict.down&(buff.avenging_wrath.up|target.health.pct<35)^t^N17^T^SEnabled^B^SName^SDivine~`Storm~`(6)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&(buff.avenging_wrath.up|target.health.pct<35)&!talent.final_verdict.enabled^t^N18^T^SEnabled^B^SName^SDivine~`Storm~`(7)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^S(buff.avenging_wrath.up|target.health.pct<35)&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*5)&!talent.final_verdict.enabled^t^N19^T^SEnabled^B^SName^SHammer~`of~`the~`Righteous^SRelease^N2.25^SAbility^Shammer_of_the_righteous^SScript^Sactive_enemies>=4&holy_power.current<5^t^N20^T^SEnabled^B^SName^SCrusader~`Strike^SRelease^N2.25^SAbility^Scrusader_strike^SScript^Sholy_power.current<5^t^N21^T^SEnabled^B^SName^SDivine~`Storm~`(8)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&buff.final_verdict.up^t^N22^T^SEnabled^B^SName^SDivine~`Storm~`(9)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_purpose.up&buff.final_verdict.up^t^N23^T^SEnabled^B^SName^SDivine~`Storm~`(10)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sholy_power.current>=4&buff.final_verdict.up^t^N24^T^SEnabled^B^SName^SFinal~`Verdict~`(2)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sbuff.divine_purpose.up&buff.final_verdict.down^t^N25^T^SEnabled^B^SName^SFinal~`Verdict~`(3)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sholy_power.current>=4&buff.final_verdict.down^t^N26^T^SEnabled^B^SName^SDivine~`Storm~`(11)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sbuff.divine_crusader.up&!talent.final_verdict.enabled^t^N27^T^SEnabled^B^SName^SDivine~`Storm~`(12)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sholy_power.current>=4&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*5)&!talent.final_verdict.enabled^t^N28^T^SEnabled^B^SName^SExorcism~`(1)^SRelease^N2.25^SAbility^Sexorcism^SScript^Sglyph.mass_exorcism.enabled&holy_power.current<5^t^N29^T^SEnabled^B^SName^SJudgment~`(2)^SArgs^Scycle_targets=1^SRelease^N2.25^SAbility^Sjudgment^SScript^Sglyph.double_jeopardy.enabled&holy_power.current<5^t^N30^T^SEnabled^B^SName^SJudgment~`(3)^SRelease^N2.25^SAbility^Sjudgment^SScript^Sholy_power.current<5^t^N31^T^SEnabled^B^SName^SExorcism~`(2)^SRelease^N2.25^SAbility^Sexorcism^SScript^Sholy_power.current<5^t^N32^T^SEnabled^B^SName^SDivine~`Storm~`(13)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sholy_power.current>=3&(!talent.seraphim.enabled|cooldown.seraphim.remains>gcd*6)&!talent.final_verdict.enabled^t^N33^T^SEnabled^B^SName^SDivine~`Storm~`(14)^SRelease^N2.25^SAbility^Sdivine_storm^SScript^Sholy_power.current>=3&buff.final_verdict.up^t^N34^T^SEnabled^B^SName^SFinal~`Verdict~`(4)^SRelease^N2.25^SAbility^Sfinal_verdict^SScript^Sholy_power.current>=3&buff.final_verdict.down^t^t^SDefault^B^t^^" )
    ...
    storeDefault( 'Ret: Buffs', 'actionLists', 20150107.1, "^1^T^SEnabled^B^SDefault^B^SScript^S^SRelease^N2.2^SSpecialization^N70^SActions^T^N1^T^SEnabled^B^SName^SBlessing~`of~`Might^SRelease^N2.06^SAbility^Sblessing_of_might^SScript^S!buff.mastery.up&!buff.blessing_of_might.up^t^N2^T^SEnabled^B^SName^SBlessing~`of~`Kings^SRelease^N2.06^SAbility^Sblessing_of_kings^SScript^S!buff.blessing_of_kings.up&!buff.str_agi_int.up&buff.mastery.up&!buff.mastery.mine&!buff.blessing_of_might.mine^t^N3^T^SEnabled^b^SName^SSeal~`of~`Truth^SRelease^N2.06^SAbility^Sseal_of_truth^SScript^Sactive_enemies<2^t^N4^T^SEnabled^b^SName^SSeal~`of~`Righteousness^SRelease^N2.06^SAbility^Sseal_of_righteousness^SScript^Sactive_enemies>=2^t^t^SName^SRet:~`Buffs^t^^" )
