...
if (select(2, UnitClass('player')) == 'PALADIN') then
  ...
  ns.initializeClassModule = function ()
    ...
    storeDefault( 'Ret: AOE', 'displays', 20150119.1, "^1^T^SPrimary~`Icon~`Size^N40^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^S^SUse~`SpellFlash^b^SSpecialization^N70^SSpacing^N4^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SSpellFlash~`Color^T^Sa^N1^Sr^N1^Sg^N1^Sb^N1^t^SMaximum~`Time^N30^SQueues^T^N1^T^SEnabled^B^SAction~`List^SRet:~`Cooldowns^SName^SCooldowns^SRelease^N2.2^SScript^Stoggle.cooldowns^t^N2^T^SEnabled^B^SAction~`List^SRet:~`AOE^SName^SAOE^SRelease^N2.2^SScript^S^t^t^SScript^S^STalent~`Group^N0^Sx^N-68^SRelease^N2.2^SIcons~`Shown^N4^SName^SRet:~`AOE^Sy^N-225^SFont^SArial~`Narrow^SDefault^B^SPvP~`Visibility^Salways^SPrimary~`Caption^Stargets^SForce~`Targets^N3^SAction~`Captions^B^SEnabled^B^t^^" )
