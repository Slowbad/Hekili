...
if (select(2, UnitClass('player')) == 'MONK') then
  ...
  ns.initializeClassModule = function ()
    ...
    storeDefault( "WW: Primary", "displays", 20150131.1, "^1^T^SPrimary~`Icon~`Size^N40^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^S^Srel^SCENTER^SUse~`SpellFlash^B^SSpecialization^N269^SSpacing^N4^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SMaximum~`Time^N30^SEnabled^B^SQueues^T^N1^T^SEnabled^B^SAction~`List^SMonk:~`Buffs^SName^SBuffs^SRelease^N2.06^SScript^Stime<2^t^N2^T^SEnabled^B^SAction~`List^SWW:~`Opener~`(Serenity~`+~`CB)^SName^SOpener~`(Serenity~`+~`CB)^SRelease^N2.25^SScript^Stoggle.cooldowns&talent.serenity.enabled&talent.chi_brew.enabled&time<13^t^N3^T^SEnabled^B^SAction~`List^SMonk:~`Interrupts^SName^SInterrupts^SRelease^N2.06^SScript^Stoggle.interrupts^t^N4^T^SEnabled^B^SAction~`List^SWW:~`Cooldowns^SName^SCooldowns^SRelease^N2.06^SScript^Stoggle.cooldowns^t^N5^T^SEnabled^B^SAction~`List^SWW:~`Single~`Target^SName^SSingle~`Target^SRelease^N2.06^SScript^S!talent.chi_explosion.enabled&(single|(cleave&my_enemies<3))^t^N6^T^SEnabled^B^SAction~`List^SWW:~`Single~`Target~`(ChiEx)^SName^SSingle~`Target~`(ChiEx)^SRelease^N2.25^SScript^Stalent.chi_explosion.enabled&(single|(cleave&my_enemies=1))^t^N7^T^SEnabled^B^SAction~`List^SWW:~`Cleave~`(ChiEx)^SName^SCleave~`(ChiEx)^SRelease^N2.25^SScript^Stalent.chi_explosion.enabled&(cleave&my_enemies=2)^t^N8^T^SEnabled^B^SAction~`List^SWW:~`AOE^SName^SAOE^SRelease^N2.06^SScript^S!talent.rushing_jade_wind.enabled&(aoe|(cleave&my_enemies>=3))^t^N9^T^SEnabled^B^SAction~`List^SWW:~`AOE~`(RJW)^SName^SAOE~`(RJW)^SRelease^N2.25^SScript^Stalent.rushing_jade_wind.enabled&(aoe|(cleave&my_enemies>=3))^t^t^SScript^S^SFont^SElvUI~`Font^SIcons~`Shown^N4^SRelease^N20150125.1^STalent~`Group^N0^SName^SWW:~`Primary^Sy^N-270^Sx^N-68^SDefault^B^SPvP~`Visibility^Salways^SPrimary~`Caption^Sdefault^SForce~`Targets^N1^SAction~`Captions^B^SSpellFlash~`Color^T^Sa^N1^Sb^N1^Sg^N1^Sr^N1^t^t^^" )
