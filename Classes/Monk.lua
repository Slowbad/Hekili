...
if (select(2, UnitClass('player')) == 'MONK') then
  ...
  ns.initializeClassModule = function ()
    ...
    addAbility( 'touch_of_death',
      {
        ...
        gcdType = 'melee',
        cooldown = 90,
        usable = function() return target.health.pct < 10 or IsUsableSpell( class.abilities[ 'touch_of_death' ].name ) end
      } )
    ...
    storeDefault( "WW: Single Target", "actionLists", 2.20, "^1^T^SEnabled^B^SDefault^B^SSpecialization^N269^SRelease^N2.2^SScript^S^SActions^T^N1^T^SEnabled^B^SName^SChi~`Brew^SRelease^N2.25^SAbility^Schi_brew^SScript^Schi.max-chi.current>=2&((charges=1&recharge_time<=10)|charges=2)&buff.tigereye_brew.stack<=16^t^N2^T^SEnabled^B^SName^STiger~`Palm^SRelease^N2.25^SAbility^Stiger_palm^SScript^Sbuff.tiger_power.remains<=3^t^N3^T^SEnabled^B^SName^STigereye~`Brew^SRelease^N2.25^SAbility^Stigereye_brew^SScript^Sbuff.tigereye_brew_use.down&buff.tigereye_brew.stack=20^t^N4^T^SEnabled^B^SName^SRising~`Sun~`Kick^SRelease^N2.25^SAbility^Srising_sun_kick^SScript^S(debuff.rising_sun_kick.down|debuff.rising_sun_kick.remains<3)^t^N5^T^SEnabled^B^SName^STiger~`Palm~`(1)^SRelease^N2.25^SAbility^Stiger_palm^SScript^Sbuff.tiger_power.down&debuff.rising_sun_kick.remains>1&energy.time_to_max>1^t^N6^T^SEnabled^B^SName^SFists~`of~`Fury^SRelease^N2.25^SAbility^Sfists_of_fury^SScript^Sbuff.tiger_power.remains>cast_time&debuff.rising_sun_kick.remains>cast_time&!buff.serenity.up^t^N7^T^SEnabled^B^SName^SFortifying~`Brew^SRelease^N2.25^SAbility^Sfortifying_brew^SScript^Starget.health.percent<10&cooldown.touch_of_death.remains=0^t^N8^T^SEnabled^B^SName^STouch~`of~`Death^SRelease^N2.25^SAbility^Stouch_of_death^SScript^Starget.health.percent<10^t^N9^T^SEnabled^B^SName^SHurricane~`Strike^SRelease^N2.25^SAbility^Shurricane_strike^SScript^Stalent.hurricane_strike.enabled&energy.time_to_max>cast_time&buff.tiger_power.remains>cast_time&debuff.rising_sun_kick.remains>cast_time&buff.energizing_brew.down^t^N10^T^SEnabled^B^SName^SEnergizing~`Brew^SRelease^N2.25^SAbility^Senergizing_brew^SScript^Scooldown.fists_of_fury.remains>6&(!talent.serenity.enabled|(!buff.serenity.up&cooldown.serenity.remains>4))&energy.current+energy.regen*gcd<50^t^N11^T^SEnabled^B^SName^SRising~`Sun~`Kick~`(1)^SRelease^N2.25^SAbility^Srising_sun_kick^SScript^S!talent.chi_explosion.enabled^t^N12^T^SEnabled^B^SName^SChi~`Wave^SRelease^N2.25^SAbility^Schi_wave^SScript^Senergy.time_to_max>2&buff.serenity.down^t^N13^T^SEnabled^B^SName^SChi~`Burst^SRelease^N2.25^SAbility^Schi_burst^SScript^Stalent.chi_burst.enabled&energy.time_to_max>2&buff.serenity.down^t^N14^T^SEnabled^B^SName^SZen~`Sphere^SArgs^Scycle_targets=1^SRelease^N2.25^SAbility^Szen_sphere^SScript^Senergy.time_to_max>2&!dot.zen_sphere.ticking&buff.serenity.down^t^N15^T^SEnabled^B^SName^SBlackout~`Kick^SRelease^N2.25^SAbility^Sblackout_kick^SScript^S!talent.chi_explosion.enabled&(buff.combo_breaker_bok.up|buff.serenity.up)^t^N16^T^SEnabled^B^SName^SChi~`Explosion^SRelease^N2.25^SAbility^Schi_explosion^SScript^Stalent.chi_explosion.enabled&chi.current>=3&buff.combo_breaker_ce.up&cooldown.fists_of_fury.remains>3^t^N17^T^SEnabled^B^SName^STiger~`Palm~`(2)^SRelease^N2.25^SAbility^Stiger_palm^SScript^Sbuff.combo_breaker_tp.up&buff.combo_breaker_tp.remains<=2^t^N18^T^SEnabled^B^SName^SBlackout~`Kick~`(1)^SRelease^N2.25^SAbility^Sblackout_kick^SScript^S!talent.chi_explosion.enabled&chi.max-chi.current<2^t^N19^T^SEnabled^B^SName^SChi~`Explosion~`(1)^SRelease^N2.25^SAbility^Schi_explosion^SScript^Stalent.chi_explosion.enabled&chi.current>=3^t^N20^T^SEnabled^B^SName^SJab^SRelease^N2.25^SAbility^Sjab^SScript^Schi.max-chi.current>=2^t^N21^T^SEnabled^B^SName^SJab~`(1)^SRelease^N2.25^SAbility^Sjab^SScript^Schi.max-chi.current>=1&talent.chi_explosion.enabled&cooldown.fists_of_fury.remains<=3^t^t^SName^SWW:~`Single~`Target^t^^" )
    
    storeDefault( "WW: AOE", "actionLists", 2.20, "^1^T^SEnabled^B^SDefault^B^SSpecialization^N269^SRelease^N2.2^SScript^S^SActions^T^N1^T^SEnabled^B^SName^SChi~`Brew^SRelease^N2.06^SAbility^Schi_brew^SScript^Schi.max-chi.current>=2&((charges=1&recharge_time<=10)|charges=2)&buff.tigereye_brew.stack<=16^t^N2^T^SEnabled^B^SName^STiger~`Palm^SRelease^N2.06^SAbility^Stiger_palm^SScript^Sbuff.tiger_power.remains<=3^t^N3^T^SEnabled^B^SName^STigereye~`Brew^SRelease^N2.06^SAbility^Stigereye_brew^SScript^Sbuff.tigereye_brew_use.down&buff.tigereye_brew.stack=20^t^N4^T^SEnabled^B^SName^SRising~`Sun~`Kick^SRelease^N2.06^SAbility^Srising_sun_kick^SScript^S(debuff.rising_sun_kick.down|debuff.rising_sun_kick.remains<3)^t^N5^T^SEnabled^B^SName^STiger~`Palm~`(1)^SRelease^N2.06^SAbility^Stiger_palm^SScript^Sbuff.tiger_power.down&debuff.rising_sun_kick.remains>1&energy.time_to_max>1^t^N6^T^SEnabled^B^SName^SChi~`Explosion^SRelease^N2.06^SAbility^Schi_explosion^SScript^Schi.current>=4&(cooldown.fists_of_fury.remains>3|!talent.rushing_jade_wind.enabled)^t^N7^T^SEnabled^B^SRelease^N2.06^SName^SRushing~`Jade~`Wind^SAbility^Srushing_jade_wind^t^N8^T^SEnabled^B^SScript^Scooldown.fists_of_fury.remains>6&(!talent.serenity.enabled|!toggle.cooldowns|(!buff.serenity.remains&cooldown.serenity.remains>4))&(energy.current+energy.regen*gcd)<50^SRelease^N2.06^SAbility^Senergizing_brew^SName^SEnergizing~`Brew^t^N9^T^SEnabled^B^SName^SRising~`Sun~`Kick~`(1)^SRelease^N2.06^SAbility^Srising_sun_kick^SScript^S!talent.rushing_jade_wind.enabled&chi.current=chi.max^t^N10^T^SEnabled^B^SName^SFists~`of~`Fury^SRelease^N2.06^SAbility^Sfists_of_fury^SScript^Stalent.rushing_jade_wind.enabled&buff.tiger_power.remains>cast_time&debuff.rising_sun_kick.remains>cast_time&!buff.serenity.up^t^N11^T^SEnabled^B^SScript^Starget.health.percent<10&cooldown.touch_of_death.remains=0^SAbility^Sfortifying_brew^SRelease^N2.06^SName^SFortifying~`Brew^t^N12^T^SEnabled^B^SName^STouch~`of~`Death^SRelease^N2.06^SAbility^Stouch_of_death^SScript^Starget.health.percent<10^t^N13^T^SEnabled^B^SName^SHurricane~`Strike^SRelease^N2.06^SAbility^Shurricane_strike^SScript^Stalent.rushing_jade_wind.enabled&talent.hurricane_strike.enabled&energy.time_to_max>cast_time&buff.tiger_power.remains>cast_time&debuff.rising_sun_kick.remains>cast_time&buff.energizing_brew.down^t^N14^T^SEnabled^B^SName^SZen~`Sphere^SArgs^Scycle_targets=1^SRelease^N2.06^SAbility^Szen_sphere^SScript^S!dot.zen_sphere.ticking^t^N15^T^SEnabled^B^SName^SChi~`Wave^SRelease^N2.06^SAbility^Schi_wave^SScript^Senergy.time_to_max>2&buff.serenity.down^t^N16^T^SEnabled^B^SName^SChi~`Burst^SRelease^N2.06^SAbility^Schi_burst^SScript^Stalent.chi_burst.enabled&energy.time_to_max>2&buff.serenity.down^t^N17^T^SEnabled^B^SName^SBlackout~`Kick^SRelease^N2.06^SAbility^Sblackout_kick^SScript^Stalent.rushing_jade_wind.enabled&!talent.chi_explosion.enabled&(buff.combo_breaker_bok.up|buff.serenity.up)^t^N18^T^SEnabled^B^SName^STiger~`Palm~`(2)^SRelease^N2.06^SAbility^Stiger_palm^SScript^Stalent.rushing_jade_wind.enabled&buff.combo_breaker_tp.up&buff.combo_breaker_tp.remains<=2^t^N19^T^SEnabled^B^SName^SBlackout~`Kick~`(1)^SRelease^N2.06^SAbility^Sblackout_kick^SScript^S(talent.rushing_jade_wind.enabled|my_enemies<3)&!talent.chi_explosion.enabled&chi.max-chi.current<2&(cooldown.fists_of_fury.remains>3|!talent.rushing_jade_wind.enabled)^t^N20^T^SEnabled^B^SName^SSpinning~`Crane~`Kick^SRelease^N2.06^SAbility^Sspinning_crane_kick^SScript^Smy_enemies>=3&!talent.rushing_jade_wind.enabled^t^N21^T^SEnabled^B^SName^SJab^SRelease^N2.06^SAbility^Sjab^SScript^S(talent.rushing_jade_wind.enabled|my_enemies<3)&chi.max-chi.current>=2^t^N22^T^SEnabled^B^SName^SJab~`(1)^SRelease^N2.06^SAbility^Sjab^SScript^Schi.current<chi.max&talent.chi_explosion.enabled&cooldown.fists_of_fury.remains<=3^t^t^SName^SWW:~`AOE^t^^" )
    ...
    storeDefault( "WW: Primary", "displays", 2.20, "^1^T^SPrimary~`Icon~`Size^N40^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^S^Srel^SCENTER^SSpellFlash~`Color^T^Sa^N1^Sr^N1^Sg^N1^Sb^N1^t^SSpecialization^N269^SSpacing^N7^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SEnabled^B^SQueues^T^N1^T^SEnabled^B^SAction~`List^SMonk:~`Buffs^SName^SBuffs^SRelease^N2.06^SScript^S^t^N2^T^SEnabled^B^SAction~`List^SWW:~`Cooldowns^SName^SCooldowns^SRelease^N2.06^SScript^Stoggle.cooldowns^t^N3^T^SEnabled^B^SAction~`List^SMonk:~`Interrupts^SName^SInterrupts^SRelease^N2.06^SScript^Stoggle.interrupts^t^N4^T^SEnabled^B^SAction~`List^SWW:~`Single~`Target^SName^SSingle~`Target^SRelease^N2.06^SScript^Ssingle|(cleave&active_enemies<3)^t^N5^T^SEnabled^B^SAction~`List^SWW:~`AOE^SName^SAOE^SRelease^N2.06^SScript^Saoe|(cleave&my_enemies>=3)^t^t^SScript^S^SFont^SUbuntu~`Condensed^STalent~`Group^N0^Sx^F-6333187512860670^f-46^SPrimary~`Caption^Sdefault^SDefault^B^Sy^N-220^SIcons~`Shown^N4^SName^SWW:~`Primary^SPvP~`Visibility^Salways^SRelease^N2.2^SForce~`Targets^N1^SAction~`Captions^B^SMaximum~`Time^N30^t^^" )
    ...
    storeDefault( "BM: Primary", "displays", 2.20, "^1^T^SPrimary~`Icon~`Size^N50^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^S^Srel^SCENTER^SSpellFlash~`Color^T^Sa^N1^Sr^N1^Sg^N1^Sb^N1^t^SSpecialization^N268^SSpacing^N5^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SMaximum~`Time^N30^SQueues^T^N1^T^SEnabled^B^SAction~`List^SMonk:~`Buffs^SName^SBuffs^SRelease^N2.06^SScript^Stime=0^t^N2^T^SEnabled^B^SAction~`List^SMonk:~`Interrupts^SName^SInterrupts^SRelease^N2.06^SScript^Stoggle.interrupts^t^N3^T^SEnabled^B^SAction~`List^SBM:~`Mitigation^SName^SMitigation^SRelease^N2.06^SScript^Stoggle.mitigation^t^N4^T^SEnabled^B^SAction~`List^SBM:~`Cooldowns^SName^SCooldowns^SRelease^N2.06^SScript^Stoggle.cooldowns^t^N5^T^SEnabled^B^SAction~`List^SBM:~`Single~`Target^SName^SSingle~`Target^SRelease^N2.06^SScript^Ssingle|(cleave&active_enemies<3)^t^N6^T^SEnabled^B^SAction~`List^SBM:~`AOE^SName^SAOE^SRelease^N2.06^SScript^Saoe|(cleave&active_enemies>2)^t^t^SScript^S^SEnabled^B^SFont^SArial~`Narrow^STalent~`Group^N0^SRelease^N2.2^SName^SBM:~`Primary^Sy^N-225^Sx^N-90^SDefault^B^SPvP~`Visibility^Salways^SPrimary~`Caption^Sdefault^SForce~`Targets^N1^SAction~`Captions^B^SIcons~`Shown^N5^t^^" )
    ...
    storeDefault( "MW: Primary", "displays", 2.20, "^1^T^SPrimary~`Icon~`Size^N50^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^SVital~`Mists^SSpellFlash~`Color^T^Sa^N1^Sr^N1^Sg^N1^Sb^N1^t^SSpecialization^N270^SSpacing^N5^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SEnabled^B^SQueues^T^N1^T^SEnabled^B^SAction~`List^N0^SName^SBuffs^SRelease^N2.06^SScript^S^t^N2^T^SEnabled^B^SAction~`List^N0^SName^SInterrupts^SRelease^N2.06^SScript^Stoggle.interrupts^t^N3^T^SEnabled^B^SAction~`List^N0^SName^SCrane~`Stance^SRelease^N2.06^SScript^S^t^t^SScript^Sstance.spirited_crane^STalent~`Group^N0^SMaximum~`Time^N30^Sx^N-90^SRelease^N2.2^SDefault^B^Sy^N-225^SIcons~`Shown^N5^SName^SMW:~`Primary^SPvP~`Visibility^Salways^SPrimary~`Caption^Sbuff^SForce~`Targets^N1^SAction~`Captions^B^SFont^SArial~`Narrow^t^^" )
