...
if (select(2, UnitClass('player')) == 'MONK') then
  ...
  ns.initializeClassModule = function ()
    ...
    storeDefault( "WW: Primary", "displays", 20150107.1, "^1^T^SPrimary~`Icon~`Size^N40^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^S^Srel^SCENTER^SSpellFlash~`Color^T^Sa^N1^Sr^N1^Sg^N1^Sb^N1^t^SSpecialization^N269^SSpacing^N7^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SMaximum~`Time^N30^SQueues^T^N1^T^SEnabled^B^SAction~`List^SMonk:~`Buffs^SName^SBuffs^SRelease^N2.06^SScript^S^t^N2^T^SEnabled^B^SAction~`List^SWW:~`Cooldowns^SName^SCooldowns^SRelease^N2.06^SScript^Stoggle.cooldowns^t^N3^T^SEnabled^B^SAction~`List^SMonk:~`Interrupts^SName^SInterrupts^SRelease^N2.06^SScript^Stoggle.interrupts^t^N4^T^SEnabled^B^SAction~`List^SWW:~`Single~`Target^SName^SSingle~`Target^SRelease^N2.06^SScript^Ssingle|(cleave&my_enemies<3)^t^N5^T^SEnabled^B^SAction~`List^SWW:~`AOE^SName^SAOE^SRelease^N2.06^SScript^Saoe|(cleave&my_enemies>=3)^t^t^SScript^S^SIcons~`Shown^N4^Sx^N-90^STalent~`Group^N0^SPrimary~`Caption^Sdefault^SDefault^B^Sy^N-220^SFont^SUbuntu~`Condensed^SName^SWW:~`Primary^SPvP~`Visibility^Salways^SRelease^N2.2^SForce~`Targets^N1^SAction~`Captions^B^SEnabled^B^t^^" )
    ...
    storeDefault( "MW: Primary", "displays", 20150110.2, "^1^T^SPrimary~`Icon~`Size^N40^SQueued~`Font~`Size^N12^SPrimary~`Font~`Size^N12^SPrimary~`Caption~`Aura^SVital~`Mists^Srel^SCENTER^SSpellFlash~`Color^T^Sa^N1^Sr^N1^Sg^N1^Sb^N1^t^SSpecialization^N270^SSpacing^N7^SQueue~`Direction^SRIGHT^SPvE~`Visibility^Salways^SQueued~`Icon~`Size^N40^SEnabled^B^SQueues^T^N1^T^SEnabled^B^SAction~`List^SMW:~`Buffs^SName^SBuffs^SRelease^N2.06^SScript^S^t^N2^T^SEnabled^B^SAction~`List^SMonk:~`Interrupts^SName^SInterrupts^SRelease^N2.06^SScript^Stoggle.interrupts^t^N3^T^SEnabled^B^SAction~`List^SMW:~`Crane^SName^SCrane~`Stance^SRelease^N2.06^SScript^S^t^t^SScript^Sstance.spirited_crane^SMaximum~`Time^N30^SIcons~`Shown^N5^Sx^N-90^SPrimary~`Caption^Sbuff^SName^SMW:~`Primary^Sy^N-225^SFont^SArial~`Narrow^SDefault^B^SPvP~`Visibility^Salways^SRelease^N20150110.1^SForce~`Targets^N1^SAction~`Captions^B^STalent~`Group^N0^t^^" )
